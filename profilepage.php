...
else if( isset($_SESSION["sup"] ) && $_SESSION["sup"] == 1 && isset( $_SESSION["access"] ) && $_SESSION["access"] == 1 )
  {
...
<td>
<a href="sendMessage.php" title="send message to administrator" style="color:white;" >
  |  Send Message |
</a>
</td>
<td>
